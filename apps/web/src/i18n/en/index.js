export default {
  ...
  households: {
    ...
    cancelAction: 'Cancel',
    deleteConfirm: 'Delete this household and all its data?',
  ...
  categories: {
    kicker: 'Settings',
    title: 'Categories',
    subtitle: 'Classify movements for reports and filters.',
  ...
  transactions: {
    ...
    delete: 'Delete',
    edit: 'Edit',
    updateAction: 'Update transaction',
    cancelAction: 'Cancel',
    import: 'Import',
    ...
    importLoaded: 'File loaded',
    importDone: 'Import completed',
    importFailed: 'Failed to import file',
    importMissing: 'Missing destinations',
    importSummaryTitle: 'Import summary',
    importSummaryImported: 'Imported',
    importSummarySkipped: 'Skipped (duplicates)',
    importSummaryFailed: 'Failed',
    importSummaryClose: 'Close',
    importEmpty: 'Upload a file to see the rows.',
    importDate: 'Date',
    importConcept: 'Concept',
    importAmount: 'Amount',
