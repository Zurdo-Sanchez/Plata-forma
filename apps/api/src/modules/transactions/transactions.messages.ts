...
const messages: Record<SupportedLocale, Record<string, string>> = {
  es: {
    ...
    duplicate: 'Ya existe una transacción igual en esa fecha.',
  ...
  ca: {
    ...
    duplicate: 'Ja existeix una transacció igual en aquesta data.',
  ...
  en: {
    ...
    duplicate: 'A matching transaction already exists on that date.',
